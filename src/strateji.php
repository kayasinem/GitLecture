...
<div class="iletisim-form">
    <form action="" method="post" class="form-style-9">
        <ul>
            <li>
                <input type="text" name="name" class="field-style field-split align-left" placeholder="İsim" />
                <input type="text" name="email" class="field-style field-split align-right" placeholder="E-Posta" />
            </li>
            <li>
                <textarea name="comment_content" class="field-style" placeholder="Yorum Ekle"></textarea>
            </li>
            <li><input type="submit" name="comment" value="Yorum Yap" /></li>
        </ul>
